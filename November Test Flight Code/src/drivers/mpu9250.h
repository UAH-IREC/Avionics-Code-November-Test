...
#define MPU9250_INT_PIN_PORT	PORTR
#define MPU9250_INT		IOPORT_CREATE_PIN(MPU9250_INT_PIN_PORT, MPU9250_INT_PIN_NUM)		//Interrupt Pin for IMU, Used as clock source
#define MPU9250_INT_LVL		PORT_INT0LVL_HI_gc
#define MPU9250_INT_vect	PORTR_INT0_vect
